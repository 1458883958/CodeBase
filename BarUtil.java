...
import com.cardplus.mobile.cardplus.ap.CPApplication;
import com.cardplus.mobile.cardplus.ap.Factory;
...
public final class BarUtil {
    ...
    public static void setStatusBarLightMode(@NonNull final Window window,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            FlymeSetStatusBarLightMode(window,isLightMode);
        }
    }
    ...
    public static int getActionBarHeight() {
        ...
        if (CPApplication.getInstance().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, CPApplication.getInstance().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = CPApplication.getInstance().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = CPApplication.getInstance()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) CPApplication.getInstance().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(CPApplication.getInstance()).hasPermanentMenuKey();
